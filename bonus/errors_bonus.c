...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/26 10:26:44 by mzuloaga          #+#    #+#             */
/*   Updated: 2024/06/26 10:39:30 by mzuloaga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
free the pointer to the array (cmd) and set it to NULL to avoid it becoming
a dangling pointer (a pointer that points to memory
...
void	*cleanup(t_clarg *clarg, char *message)
{
	...
	if (clarg != NULL)
	{
		...
		if (clarg->hd_delim != NULL
			&& ft_strncmp(message, UNLINK, ft_strlen(message)) != 0)
		{
